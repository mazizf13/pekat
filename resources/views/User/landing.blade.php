...
@section('title', 'PEKAT TIMUR - Pengaduan Masyarakat')
...
<section class="header">
        ...
        <div class="container">
            <div class="container-fluid">
                <a class="navbar-brand" href="#">
                    <h4 class="semi-bold mb-0 text-white">PEKAT TIMUR</h4>
                    <p class="italic mt-0 text-white">Perumahan Rungkut Asri Timur</p>
                </a>
    ...
    <div class="text-center">
        ...
        <p class="italic text-white mb-5">Sampaikan langsung laporan Anda kepada pengelola Perumahan Rungkut Asri Timur</p>
    </div>
...
<div class="row justify-content-center">
    <div class="col-lg-6 col-10 col">
        <div class="content shadow">
            ...
            <div class="card mb-3">Tulis Laporan</div>
...
<div class="mt-5">
    <hr>
    <div class="text-center">
        <p class="italic text-secondary">© 2024 <span><a href="https://instagram.com/mazizf_" target="_blank">azxx</a></span> • All rights reserved</p>
    </div>
</div>
